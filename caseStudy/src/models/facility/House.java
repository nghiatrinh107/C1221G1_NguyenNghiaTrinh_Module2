...
public class House extends Facility {
    ...
    public House(int idFacility,String hotelService, double roomArea, int rate, int maximumCapacity, String rentStyle, String kindOfRoom, double swimmingPool, int floor) {
